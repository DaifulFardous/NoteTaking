                    ...
                    <div class="card-body">
                        <form action="{{ route('note.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg" id="note_title" name="title" placeholder="Enter note title">
                            </div>
                            <div class="form-group">
                                <label for="note_content" class="font-weight-bold h4">Content</label>
                                <textarea class="form-control form-control-lg" id="note_content" name="content" placeholder="Enter note content" rows="8"></textarea>
                            </div>
